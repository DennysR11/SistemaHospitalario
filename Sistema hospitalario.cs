...
namespace ConsoleApplication1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            int validar = misFunciones.ImprimirMenu();
            ...
            {
                Console.Clear();
                misFunciones.ValidarMenu(validar);
            }
            else
            {
                Console.WriteLine("\t\tOPCION INCORRECTA!!!!!!   Vulva a ingresar una opcion");
                int validarError = misFunciones.ImprimirMenu();
                misFunciones.ValidarMenu(validarError);
            }
        }
        //===========================================================================================
    }
